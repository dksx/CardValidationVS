...
internal class TestConstants
{
    ...
    internal static readonly ValidateCardRequest GoodRequest = new ValidateCardRequest { CardNumber = "4263982640269299", Cvc = 420, FullName = "John Doe", ExpirationDate = new DateTime(2030, 1, 1) };
